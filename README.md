...
### Area of Improvement 
One area of improvement that could be made in this project is to make the code in the machine learning models easier to read with the use of def() functions as they were used earlier. Functions could have been used to effienctly visualize the ROC, PRC curves along with the feature importance charts and the confusion matrices
