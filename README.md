...
| **Net Fraud Recovery (Fraud Caught - Legit Blocked)** | **$631,342** | **$617,890** | **$551,017** | **$612,264** |

Despite RF Tuned having slightly a lower net recovery than RF Untuned, it was selected for deployment because it catches the most raw fraud value ($1,002,299) and reduces missed fraud to its lowest point ($131,025). In a real fraud system, minimizing undetected fraud is the priority — false positives can be resolved through the review tier, but missed fraud is unrecoverable.
---
